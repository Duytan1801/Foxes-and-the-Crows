...
*** START OF THE PROJECT GUTENBERG EBOOK ELLIPTIC FUNCTIONS ***
\end{PGtext}
\end{minipage}
\end{center}
...
Functions; \textsc{Byerly's} Integral Calculus; \textsc{Schlömilch's}
Compendium der höheren Analysis; \textsc{Briot et Bouquet's} Fonctions Elliptiques.}
...
\begin{PGtext}
*** END OF THE PROJECT GUTENBERG EBOOK ELLIPTIC FUNCTIONS ***
